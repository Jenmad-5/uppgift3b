...
Om man inte får information vid alla rubriker innebär det att man inte har fyllt i alla fält
eller att det är något fel i din kod. Det som händer när man klickar på Submit är att formulärets
data skickas till en php-sida som tolkar data och presenterar resultatet. Denna php-sida är klar 
och fungerande så den biten behöver du inte bry dig om.
</p>
